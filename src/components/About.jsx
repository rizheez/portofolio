            ...
            <div className="container mx-auto px-4 py-32 ">
                <div className="bg-slate-200 opacity-80 rounded-lg shadow-lg p-6 animate__fadeIn" data-aos="fade-down" data-aos-delay="250" >
                    ...
                    <div className="grid grid-cols-2 md:grid-cols-6 gap-4 text-2xl pt-5 ">
                        { skills.map((skill) => (
                            <div key={ skill.name } className="bg-gray-200 rounded-md p-2 md:w-42 md:flex border border-black hover:bg-blue-500 transition ease-in-out delay-150 hover:scale-110 hover:text-white  duration-300">
                            ...
                            { certificate.map((cert) => (
                                <div key={ cert.name } className="bg-white rounded-lg shadow-lg p-4 w-96 transition ease-in-out delay-150 hover:scale-105 duration-200">
                                    <div className="bg-gray-200 h-40 flex items-center justify-center rounded-lg mb-4">
                                        <img src={ cert.image } alt="Sertifikat 1" className="h-full w-full object-cover rounded-lg" />
                                    </div>
